...
/// World-anchored hash (brief 01 §2.4).
///
/// Integer world coordinates only — never screen position, never time, so
/// decoration is nailed to the ground and cannot boil under scroll.
#[inline]
